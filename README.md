...
​	ioGame 是一个由 **java** 语言编写的高性能、稳定的、易用的、超好的编程体验的、**开源游戏服务器框架**。ioGame 适用于各类游戏服务器的开发，包括 H5（HTML5）、手游、端游等游戏服务器。

​	在网络游戏框架中能让你遗忘Netty，你几乎**没有机会**能直接的接触到Netty的**复杂**，但却能享受Netty带来的**高性能**。对开发者要求低，**为开发者节约时间**，为企业减少人工成本。
...
- 心跳相关 
- 用户上线、离线相关的钩子方法
- UserSession （对所有用户Channel的管理，统计在线用户等）
